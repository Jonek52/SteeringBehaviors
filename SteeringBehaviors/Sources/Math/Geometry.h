...
inline span_type WhereIsPoint( Vector2 point,
...
//------------------------------------------------------------------------
inline float DistToLineSegment( Vector2 A, Vector2 B, Vector2 P )
{
...
//------------------------------------------------------------------------
inline float DistToLineSegmentSq( Vector2 A, Vector2 B, Vector2 P )
{
	// if the angle is obtuse between PA and AB is obtuse then the closest
	// vertex must be A
	float dotA = ( P.x - A.x ) * ( B.x - A.x ) + ( P.y - A.y ) * ( B.y - A.y );
...
inline bool LineIntersection2D( Vector2 A, Vector2 B, Vector2 C, Vector2 D )
{
...
inline bool LineIntersection2D( Vector2 A, Vector2 B, Vector2 C, Vector2 D, float& dist )
{
...
//------------------------------------------------------------------------
inline bool ObjectIntersection2D( const std::vector< Vector2 >& object1, const std::vector< Vector2 >& object2 )
{
...
//-----------------------------------------------------------------------
inline float TwoCirclesIntersectionArea( float x1, float y1, float r1, float x2, float y2, float r2 )
{
	...
	float area
		= 0.5f * CBD * r2 * r2 - 0.5f * r2 * r2 * sin( CBD ) + 0.5f * CAD * r1 * r1 - 0.5f * r1 * r1 * sin( CAD );
...
//------------------------------------------------------------------------
inline bool LineSegmentCircleIntersection( Vector2 A, Vector2 B, Vector2 P, float radius )
{
